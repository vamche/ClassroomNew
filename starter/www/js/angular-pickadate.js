    ...
    .directive('pickadate', ['$locale', '$timeout', 'pickadateUtils', 'pickadateI18n', 'dateFilter', function($locale, $timeout, dateUtils, i18n, dateFilter) {
        return {
            ...
            '</div>' +*/
                ...
                '<div id="Row1" class="selectedDateRow ng-hide padding animated fadeIn">' +
                ...
                '<div id="Row2" class="selectedDateRow ng-hide padding animated fadeIn">' +
                ...
                '<div id="Row3" class="selectedDateRow ng-hide padding animated fadeIn">' +
                ...
                '<div id="Row4" class="selectedDateRow ng-hide padding animated fadeIn">' +
                ...
                '<div id="Row5" class="selectedDateRow ng-hide padding animated fadeIn">' +
                ...
                '<div id="Row6" class="selectedDateRow ng-hide padding animated fadeIn">' +
